...
class Service {
    ...
    factory Service.fromJson(Map<String, dynamic> json) => Service(
        ...
        districtAvailable: List<DistrictAvailable>.from(json["districtAvailable"].map((x) => DistrictAvailable.fromJson(x))),
        imageService: List<ImageService>.from(json["imageService"].map((x) => ImageService.fromJson(x))),
        userId: json["userId"],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "address": address,
        "districtAvailable": List<dynamic>.from(districtAvailable.map((x) => x.toJson())),
...
class DistrictAvailable {
    ...
    factory DistrictAvailable.fromJson(Map<String, dynamic> json) => DistrictAvailable(
        id: json["_id"],
