...
class OrdersProductsCompletedDetailsPage extends StatelessWidget {
  final OrderProductResponse ordersProductsCompleted;
  final Function hp;
  final int indexOrder;

  OrdersProductsCompletedDetailsPage(
      {this.ordersProductsCompleted, this.hp, this.indexOrder});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: Text(
            'ID ${ordersProductsCompleted.id.toUpperCase().substring(0, 8)}',
          ...
          actions: [
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(fontSize: hp(1.3), color: kprimarycolorlight),
              ),
              color: kdialogicon,
            )
          ]),
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${ordersProductsCompleted.clientName}')
                              ],
                            ),
                          ),
                          Divider(),
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                    '${ordersProductsCompleted.clientCellphone}')
                              ],
                            ),
                          ),
                          Divider(),
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${ordersProductsCompleted.clientAddress}')
                              ],
                            ),
                          ),
                        ],
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          final orderedProducts =
                              ordersProductsCompleted.selectedProducts[index];
                          return FutureBuilder<Product>(
                              future: getOrderedProductById(
                                  ordersProductsCompleted
                        ...
                        itemCount:
                            ordersProductsCompleted.selectedProducts.length),
                  ),
                  SizedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            Text(
                              'Total',
                              style: TextStyle(
                                  color: kintroNotSelected, fontSize: hp(2)),
                            ),
                            Text(
                              'S/ ${ordersProductsCompleted.totalPrice}.00',
                              style: TextStyle(
                                  color: kdarkcolor,
                                  fontSize: hp(3),
                                  fontWeight: FontWeight.bold),
