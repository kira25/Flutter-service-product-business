...
class OrdersProductsRejectedPage extends StatelessWidget {
  final OrderProductResponse ordersProductsRejected;
  final Function hp;
  final int indexOrder;

   OrdersProductsRejectedPage({Key key, this.ordersProductsRejected, this.hp, this.indexOrder}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(
          ...
          title: Text(
            'ID ${ordersProductsRejected.id.toUpperCase().substring(0, 8)}',
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${ordersProductsRejected.clientName}')
                              ],
                            ),
                          ),
                          Divider(),
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                    '${ordersProductsRejected.clientCellphone}')
                              ],
                            ),
                          ),
                          Divider(),
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Text('${ordersProductsRejected.clientAddress}')
                              ],
                            ),
                          ),
                        ],
                  ...
                  Container(
                    ...
                    child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          ordersProductsRejected.selectedProducts[index];
                          return FutureBuilder<Product>(
                              future: getOrderedProductById(
                                  ordersProductsRejected
                        ...
                        itemCount:
                        ordersProductsRejected.selectedProducts.length),
                  ),
                  SizedBox(
                    height: hp(2),
                  ),
