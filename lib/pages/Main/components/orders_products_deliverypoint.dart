...
class OrderProductsDeliveryPointPage extends StatelessWidget {
  final OrderProductResponse ordersProductsFollowing;
  final Function hp;
  final int indexOrder;

  OrderProductsDeliveryPointPage(
      ...
      appBar: AppBar(
        ...
        actions: [
          Container(
            ...
            child: Text(
              'En camino al pto de entrega'.toUpperCase(),
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: hp(1.1), color: kprimarycolorlight),
            ),
