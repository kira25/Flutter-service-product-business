...
class OrdersProductsAssigningPage extends StatelessWidget {
  final OrderProductResponse ordersProductsFollowing;
  final Function hp;
  final int indexOrder;

  OrdersProductsAssigningPage(
          ...
          appBar: AppBar(
            ...
            actions: [
              Container(
                ...
                child: Text(
                  'Asignando repartidor'.toUpperCase(),
                      ...
                      child: Card(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              //TODO: MAKE A CALL TO THE DELIVERY
                              onTap: () => print('Call delivery'),
                              child: Padding(
                                padding:
